...
This repository is a fork of `rust-clippy` in which some lints are re-implemented using the 
[syntax tree pattern matching](https://github.com/fkohlgrueber/pattern-matching/tree/master) 
